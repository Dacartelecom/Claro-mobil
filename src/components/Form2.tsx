...
export const Form2 : FC<FormProps>=({
    ...
    return(
        <form className={`flex flex-col w-[450px] h-[400px] justify-start rounded-md sombra text-[#B7202E] ${modal ? 'top-[100px] right-[5%] max-lg:top-[10px] max-lg:right-0' : ''}  text-[#222222] ${ className }`} onSubmit={sendNumber}>
            ...
            <div className="w-full bg-white h-[360px] flex flex-col text-center text-[24px] font-bold gap-[20px] rounded-lg p-[5px]"> 
                ...
                <div className="flex w-full flex-col gap-[15px]">
                    <span className="text-[15px] text-left text-black">Déjanos tu número y te llamaremos</span>
                    ...
                    <span className="text-[15px] text-left flex gap-[5px] text-black">
                        <input type="checkbox" 
                        checked={isChecked}
