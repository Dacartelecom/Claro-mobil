  ...
  return (
    <div className='w-full h-[90px] bg-[#EF3829] text-white flex justify-around items-center max-lg:flex-col max-lg:h-[150px] max-lg:items-center max-lg:justify-center'>
      ...
      <div className='w-[700px] font-normal text-2xl flex justify-evenly max-lg:w-full h-full max-lg:text-xl max-lg:flex-col max-lg:items-center max-lg:mt-5'>
        ...
        <div className=" w-[350px] max-lg:w-[80%] flex items-center justify-center text-center m-auto max-lg:my-[20px]">
            <button
              className=" bg-[#ff3a2d] flex justify-center gap-2 items-center rounded-full border-2 border-white text-white text-[13px] font-bold uppercase max-md:text-[13px] w-[500px] hover:text-[#ff3a2d] hover:bg-white duration-300 transition-all"
              onClick={ active }
            >
              <i className="fa-solid fa-hand-point-right"></i>
              <span className="text-[12px]">"{ messageButton }"</span>
            </button>
          </div>
      </div>
      <Modal
