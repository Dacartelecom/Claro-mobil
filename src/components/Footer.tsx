...
export const Footer = () => {
    ...
    return (
        <>
            ...
            <a href={`tel:${number.tel}`} className="fixed md:hidden z-[100] rounded-full p-3 left-2 bottom-2 bg-[#EF3829]">
            <svg className="size-[50px] m-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="#fff">
