...
export const Footer = () => {
    ...
    return (
        <>
            <footer className='bg-black w-full h-[200px] m-auto'>
                <div className='w-[70%] h-full flex mx-auto flex-col text-white items-center justify-end gap-[30px] py-1'>
                    <div className='w-full flex justify-between'>
                        <div className='flex flex-col'>
                            <span className='text-[40px]'>redes sociales</span>
                            <span className='text-[20px] leading-[20px]'>Av. Ramon vargas Machuca 300 <br />San juan de Miraflores</span>
                        </div>
                        <div className='flex flex-col text-right'>
                            <span className='text-[40px]'><a href={`tel:${number.tel}`} > {number.num}</a></span>
                            <span className='text-[20px]'>Distribuidor@ejemplo.pe</span>
                        </div>
                    </div>

                    <div className='w-full flex justify-between'>
                        <div>Nombre del distrinuidor (c) distribuidor oficial de Claro</div>
